            ...
            <div ClassName="container-fluid page" id={id}>
                ...
                <div className="row texts">
                    <div className="col-sm-6" data-aos="fade-left">
                        ...
                        <h5>VISION</h5>
                        <p><strong> Our vision </strong>is to make sure every child attains the right<br />
                        ...
                        <p>We also aim to work to an environment which no child’s life<br />
                            ...
                            of children today in the <strong>Democratic Republic of Congo.</strong>
                        </p>
                        ...
                        the right to grow up free from fear and violence, to develop to their full<br />
                    ...
                    <div className="col-sm-6" data-aos="fade-right">
                        ...
                        <h5>MISSION</h5>
                        <p>To inspire breakthroughs in the way the <strong>Democratic Republic of Congo.</strong> <br />
         treats children and to achieve immediate and lasting change in their lives.</p>
                        <p>To help children create a future of hope for themselves,<br />
                        ...
                        <p>To help eliminate hunger and improve the health<br />
                ...
                <div className="video texts" data-aos="fade-up">
                    ...
                    that every child has the potential to change his or her own life and that of the world at large.<br />
                     This belief remains at the heart of the organization today. <br />
                    And it underpins everything we say and do - as reflected in our strategy <strong>‘what we believe, what we’ll do.’</strong>
                    </p>
                    ...
                    <p>Together we can ensure that every child survives, learns and thrive.<br />
                     And so they can realize their full potential build a better world.<br />
