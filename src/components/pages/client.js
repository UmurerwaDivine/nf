      ...
      <div ClassName="client" id={id}>
        <div className="row images">
          ...
          <div className="col-sm-4">
            ...
            <h5>OUR MISSION</h5>
            <p>
              To inspire breakthroughs the way the
              <br />
              Democratic Republic of Congo <br />
              treats children and to achieve
              <br />
