      ...
      <div className="container-fluid about" id={id}>
        <div className="row content">
          ...
          <div className="col-sm-6 more">
            <p id="heading" data-aos="fade-down">
              WHO WE ARE
            </p>

            <div data-aos="fade-up" className="paragraph">
              <p>
                <strong>Child and Youth Care organization(cyco)</strong>
                <br />
                is a non-governmental Organization does whatever it takes every
                day
                <br />
                and in times of crisis to give children a healthy start in life,
                <br />
              ...
              <p>
                ...
                <br />
                we are always among the first to respond
                <br />
